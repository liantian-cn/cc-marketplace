...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/liantian-cc-env-setup/scripts/set_env.py" set QCC_API_KEY "your-api-key-here"
```
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/liantian-cc-env-setup/scripts/set_env.py" set \
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/liantian-cc-env-setup/scripts/set_env.py" set DASHSCOPE_API_KEY "sk-your-dashscope-key"
```
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/liantian-cc-env-setup/scripts/set_env.py" set TAVILY_API_KEY "tvly-your-tavily-key"
```
...
python "${CLAUDE_PLUGIN_ROOT}/skills/liantian-cc-env-setup/scripts/set_env.py" list
